      ...
      <div className="container mb-2" ref={firstContainerRef}>
        ...
        <div className="row">
          <div className="col-lg-4 col-md-6 mb-2 firstImgContainer">
            <img src="src/components/images/img-3.JPG" alt="pictures of coins" className='img-fluid w-100 h-100 logo-2 mb-1' />
          ...
          <div className="col-lg-4 col-md-6 mb-2 secondImgContainer">
            <img src="src/components/images/img-4.JPG" alt="a lady typing on a laptop" className='img-fluid w-100 h-100 logo-3 mb-1' />

            {/* I gave the same className for the paragraph because it aids the styling */}
            <p className='exam-preparations'>Accounting Materials</p>
          </div>
          <div className="col-lg-4 col-md-6 mb-2 thirdImgContainer">
            <img src="src/components/images/img-5.JPG" alt="two ladies close to each other" className='img-fluid w-100 h-100 logo-4 mb-1' />
